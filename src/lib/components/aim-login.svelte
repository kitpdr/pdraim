...
>
	<div class="title-bar">
		<div class="title-bar-text">
			<img
				src="/desktop/aim-desktop-icon.png"
				alt="AIM"
				class="title-icon"
				width="16"
				height="16"
	...
	<div class="tabs">
		<button class:active={activeTab === 'signin'} onclick={() => switchTab('signin')}
			>Connexion</button
		>
		<button class:active={activeTab === 'signup'} onclick={() => switchTab('signup')}
			>Inscription</button
		>
	</div>
		...
		{#if activeTab === 'signin'}
			<form onsubmit={handleSigninSubmit}>
				...
				<div class="button-bar">
					<button
						type="submit"
						class="icon-button {loginStatus === 'success'
							? 'success-border'
							: loginStatus === 'error'
								? 'error-border'
								: ''}"
					>
						...
						{:else}
							...
							>
								<path
									d="M12 4C9.24 4 7 6.24 7 9c0 2.76 2.24 5 5 5s5-2.24 5-5c0-2.76-2.24-5-5-5zm0 2c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 10c-3.33 0-7 1.67-7 5v1h14v-1c0-3.33-3.67-5-7-5zm0 2c2.67 0 5 1.33 5 3H7c0-1.67 2.33-3 5-3z"
									fill="currentColor"
								/>
							</svg>
						{/if}
		...
		{:else}
			<form onsubmit={handleSignupSubmit}>
				...
				<div class="button-bar">
					<button
						type="submit"
						class="icon-button {signupStatus === 'success'
							? 'success-border'
							: signupStatus === 'error'
								? 'error-border'
								: ''}"
