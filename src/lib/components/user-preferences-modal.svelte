<script lang="ts">
	...
	// Props
	let { showModal = $bindable(false), onSave } = $props<{
		showModal: boolean;
		...
		<div class="modal-window window" onclick={(e) => e.stopPropagation()}>
			...
			<div class="window-body">
				<div class="preferences-content">
					...
					<div class="preference-group">
						<label class="checkbox-label">
							<input type="checkbox" bind:checked={preferences.allowFormatting} />
				...
				<div class="modal-buttons">
					<button class="reset-button" onclick={resetToDefaults} disabled={isSaving}>
						Reset to Defaults
					</button>
